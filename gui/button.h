...
*/
#define GUI_BUTTON_BG_COLOR DARKBLUE
#define GUI_BUTTON_TEXT_COLOR WHITE
#define GUI_BUTTON_HOVER_COLOR SKYBLUE
#define GUI_BUTTON_ACTIVE_COLOR BLUE
...
/*
    ...
    The width of the button is determined by r.w
        If r.w is 0 then the width is defined by the label and font size.
*/
